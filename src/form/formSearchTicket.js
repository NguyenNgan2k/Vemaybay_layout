                        ...
                        <div className="flex w-full">
                            <div className="w-2/3 mr-10">
                                <div className="flex justify-between mb-4">
                                    <div className="w-56">
                                        <label className="text-[#837a76] font-medium">Điểm đi</label>
                                    ...
                                    <div className="w-56">
                                        <label className="text-[#837a76] font-medium">Điểm đến</label>
                                        <div className="border-b border-[#f7941d]">
                                            <div>Nhập thành phố/mã sân bay</div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex justify-between mb-2">
                                    <div className="w-56">
                                        <label className="text-[#837a76] font-medium">Ngày đi</label>
                                      <Field
                                      name="formDateGo"
                                    ...
                                    <img src={Convert} className="h-2 self-end mb-2" />
                                    <div className="w-56">
                                        <label className="text-[#837a76] font-medium">Ngày về</label>
                                        <Field
                                      name="formDateReturn"
                                      component={RenderDate}
